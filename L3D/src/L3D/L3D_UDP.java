 ...
 *
 * @version 0.1
 * @author Cousot Stephane - stef@ubaa.net
 * @author Douglas Edric Stanley - http://www.abstractmachine.net/
 */
public class L3D_UDP implements Runnable {
	 ...
	 */
	public L3D_UDP( Object owner, int port ) {
	 ...
	 */
	public L3D_UDP( Object owner, int port, String ip ) {
	 ...
	 *
	 * @see	L3D_UDP#send(String message, String ip)
	 * @see	L3D_UDP#send(String message, String ip, int port)
	 *
	 * @return boolean
	 */
	 ...
	 *
	 * @see	L3D_UDP#send(byte[] data, String ip)
	 * @see	L3D_UDP#send(byte[] data, String ip, int port)
	 *
	 * @return boolean
	 */
	 ...
	 *
	 * @see	L3D_UDP#send(String message)
	 * @see	L3D_UDP#send(String message, String ip, int port)
	 *
	 * @return boolean
	 */
	 ...
	 * @param ip		the destination host's IP address
	 *
	 * @see	L3D_UDP#send(byte[] buffer)
	 * @see	L3D_UDP#send(byte[] buffer, String ip, int port)
	 *
	 * @return boolean
	 */
	 ...
	 * @param port		the destination host's port
	 *
	 * @see	L3D_UDP#send(byte[] buffer, String ip)
	 * @see	L3D_UDP#send(byte[] buffer, String ip, int port)
	 *
	 * @return boolean
	 */
	 ...
	 * @return int
	 * @see L3D_UDP#setBuffer(int size)
	 */
	 ...
	 *
	 * @see L3D_UDP#listen()
	 * @see L3D_UDP#listen(int millis)
	 * @see L3D_UDP#setReceiveHandler(String name)
	 */
	 ...
	 * thread, use the {@link L3D_UDP#listen(int millis)} or 
	 * {@link L3D_UDP#listen(boolean on)} method instead.
	 *
	 * @see L3D_UDP#listen()
	 * @see L3D_UDP#listen(boolean on)
	 * @see L3D_UDP#setReceiveHandler(String name)
	 ...
	 * @see L3D_UDP#setTimeoutHandler(String name)
	 */
	 ...
	 *
	 * @return int
	 * @see L3D_UDP#setTimeToLive(int ttl)
	 */
	...
	private void log( String out ) {
		...
		if ( !log && header.equals("") )
			header = "-- L3D_UDP session started at "+date+" --\n-- "+out+" --\n";
